...
public:
    ...
    {
        if (!isValidIndex(bitIndex, bitCount))
            return false;
    ...
    bool Set(uint8_t bitIndex, bool value)
    {
        ...
        BitFlag::Set(_bits, bitIndex, value);
        return true;
    }
    ...
    bool IsTrue(uint8_t bitIndex) const
    {
        ...
        return BitFlag::IsTrue(_bits, bitIndex);
    }
    ...
    bool IsFalse(uint8_t bitIndex) const
    {
        ...
        return BitFlag::IsFalse(_bits, bitIndex);
    }
